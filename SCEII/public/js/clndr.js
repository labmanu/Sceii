  ...
  var clndrTemplate =
    "<div class='clndr-controls'>" +
        "<div class='clndr-control-button'>" +
            "<span class='clndr-previous-button'><i class='fa-solid fa-arrow-left fa-2x'></i></span>" +
        '</div>' +
        "<div class='month'><%= month %> <%= year %></div>" +
        "<div class='clndr-control-button rightalign'>" +
            "<span class='clndr-next-button'><i class='fa-solid fa-arrow-right fa-2x'></span>" +
        '</div>' +
    '</div>' +
    "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
        '<thead>' +
            ...
            "<td class='header-day'>LUN.</td>" +
            "<td class='header-day'>MAR.</td>" +
            "<td class='header-day'>MIÉ.</td>" +
            "<td class='header-day'>JUE.</td>" +
            "<td class='header-day'>VIE.</td>" +
            "<td class='header-day'>SÁB.</td>" +
