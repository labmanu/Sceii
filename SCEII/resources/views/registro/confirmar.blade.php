...
<head>
    ...
    <!--=============== FAVICON ===============-->
    <link rel="shortcut icon" href="{{ asset('public/img/faviconLight.png') }}" type="image/x-icon" />
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="https://labmanufactura.net/" class="nav__logo">
                <img src="{{ asset('public/img/faviconLight.png') }}" width="40" height="40" id="logo_img">
                SCEII
            </a>
    ...
    <main class="main">
        ...
        <section class="home" id="home">
            <div class="home__container container grid">
                <img src={{ !isset($error) ? '../public/img/welcome.png' : '../public/img/error.png' }} alt=""
                    class="home__img" />
        ...
        <footer class="footer section">
            <div class="footer__container container grid">
                ...
                <div class="footer__content">
                    ...
                    <ul class="footer__data">
                        <li class="footer__information"><a href="https://www.facebook.com/sare.isaias">Ramírez García
                                Marco Isaías </a></li>
                        <li class="footer__information"><a href="https://www.facebook.com/luis.davidraw">García
                                Ramírez Luis David</a></li>
                        <li class="footer__information"><a href="https://www.facebook.com/">Martinez Hernandez Edgar
                                Gabriel</a></li>
                    </ul>
                </div>
            </div>
